...
QT_MOC_LITERAL(10, 111, 20), // "registerDataReceived"
QT_MOC_LITERAL(11, 132, 8), // "uint32_t"
QT_MOC_LITERAL(12, 141, 7), // "regAddr"
QT_MOC_LITERAL(13, 149, 7), // "regData"
QT_MOC_LITERAL(14, 157, 17), // "powerDataReceived"
QT_MOC_LITERAL(15, 175, 20), // "QVector<QVariantMap>"
QT_MOC_LITERAL(16, 196, 9), // "powerData"
QT_MOC_LITERAL(17, 206, 23), // "temperatureDataReceived"
QT_MOC_LITERAL(18, 230, 8), // "tempData"
QT_MOC_LITERAL(19, 239, 19), // "voltageDataReceived"
QT_MOC_LITERAL(20, 259, 11), // "voltageData"
QT_MOC_LITERAL(21, 271, 19), // "digitalInputChanged"
QT_MOC_LITERAL(22, 291, 8), // "isGroupA"
QT_MOC_LITERAL(23, 300, 7), // "uint8_t"
QT_MOC_LITERAL(24, 308, 7), // "diValue"
QT_MOC_LITERAL(25, 316, 21), // "handleWorkerConnected"
QT_MOC_LITERAL(26, 338, 24), // "handleWorkerDisconnected"
QT_MOC_LITERAL(27, 363, 17), // "handleWorkerError"
QT_MOC_LITERAL(28, 381, 24), // "handleWorkerDataReceived"
QT_MOC_LITERAL(29, 406, 16) // "handleFtdiStatus"

    },
    "UsbCommunication\0connectionChanged\0\0"
    "connected\0errorOccurred\0message\0"
    "dataReceived\0data\0ftdiStatusChanged\0"
    "status\0registerDataReceived\0uint32_t\0"
    "regAddr\0regData\0powerDataReceived\0"
...
static const uint qt_meta_data_UsbCommunication[] = {
 ...
 // signals: parameters
    ...
    QMetaType::Void, QMetaType::Bool, 0x80000000 | 23,   22,   24,
...
void UsbCommunication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->registerDataReceived((*reinterpret_cast< uint32_t(*)>(_a[1])),(*reinterpret_cast< uint32_t(*)>(_a[2]))); break;
        case 5: _t->powerDataReceived((*reinterpret_cast< const QVector<QVariantMap>(*)>(_a[1]))); break;
        case 6: _t->temperatureDataReceived((*reinterpret_cast< const QVector<QVariantMap>(*)>(_a[1]))); break;
        case 7: _t->voltageDataReceived((*reinterpret_cast< const QVector<QVariantMap>(*)>(_a[1]))); break;
        case 8: _t->digitalInputChanged((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< uint8_t(*)>(_a[2]))); break;
        case 9: _t->handleWorkerConnected(); break;
        case 10: _t->handleWorkerDisconnected(); break;
        case 11: _t->handleWorkerError((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 12: _t->handleWorkerDataReceived((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        case 13: _t->handleFtdiStatus((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::RegisterMethodArgumentMetaType) {
        switch (_id) {
